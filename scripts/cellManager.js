...
class ChunkedCellManager {
    ...
    setCell(q, r, s, value) {
        ...
        chunk[this._localIndex(lx, ly, lz)] = value ? 1 : 0;
    }
...
class CellManager {
    constructor(width = 20, height = 20, depth = 20) {
        ...
        const useChunked = width > threshold || height > threshold;
...
resize(newWidth, newHeight, newDepth = 1) {
    const threshold = 2500;
    const useChunked = newWidth > threshold || newHeight > threshold;
